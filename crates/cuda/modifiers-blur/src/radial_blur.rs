...
pub(crate) mod device {
    ...
    pub fn radial_blur(
        ...
        for sample in 0..sample_count {
            ...
            let sample_angle = params.angle * (fraction - 0.5);
            let sine = math::sin_f32(sample_angle);
            let cosine = math::sin_f32(sample_angle + core::f32::consts::FRAC_PI_2);
            let sample_x = center_x + dx * cosine - dy * sine;
            let sample_y = center_y + dx * sine + dy * cosine;

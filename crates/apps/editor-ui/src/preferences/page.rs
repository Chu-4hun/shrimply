...
pub fn show_preferences_dialog(
    ...
    let default_font_row = adw::ActionRow::builder().title("Default Text Font").build();
    let default_font =
    ...
    caption_font_size.set_title("Font Size");
    caption_font_size.set_value(snapshot.caption_font_size as f64);
    caption_font_size.set_digits(0);

    let caption_background_color_row = adw::ActionRow::builder().title("Background Color").build();

    let caption_group = adw::PreferencesGroup::new();
    caption_group.set_title("Captions");
    ...
    default_visual_duration.set_title("Default Visual Duration");
    ...
    snap_radius.set_title("Snap Attraction Radius");
    snap_radius.set_subtitle("Distance in pixels for timeline, beat, and preview snapping");
    ...
    timeline_group.set_title("Timeline");
    ...
    preview_padding.set_title("Padding");
    preview_padding.set_subtitle("Space around the video frame in pixels");
    ...
    preview_shadow_size.set_title("Shadow Size");
    preview_shadow_size.set_subtitle("Drop shadow extent around the video frame in pixels");
    ...
    temporal_decoder_pool_size.set_title("Temporal Decoder Pool Size");
    temporal_decoder_pool_size.set_subtitle("Maximum number of active video decoder sessions");
    ...
    image_pool_cpu.set_title("Image Pool CPU Budget");
    image_pool_cpu.set_subtitle("Static image cache in system RAM (GiB)");
    ...
    let clear_blender = gtk::Button::builder()
        ...
        .tooltip_text("Clear Blender binary")
    ...
    blender_group.set_title("Blender");
    ...
    clear_blender.connect_clicked(move |_| {
        ...
        clear_row.set_subtitle("Not configured");
    });

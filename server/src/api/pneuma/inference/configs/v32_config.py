...
@dataclass(frozen=True, slots=True)
class V32Config:
    data: V32DataConfig = field(default_factory=V32DataConfig)
    model: V32ModelConfig = field(default_factory=V32ModelConfig)


def get_v32_config() -> V32Config:
    return V32Config()

...
pub(super) fn draw_text_drop_preview(
    draw: &TimelineDraw<'_>,
    project: &Project,
...
pub(super) fn draw_dragged_group(
    draw: &TimelineDraw<'_>,
    project: &Project,
    group: &DraggedGroup,
    virtual_tracks: &[(TrackKind, usize)],
...
pub(super) fn draw_folded_new_track_preview(
    draw: &TimelineDraw<'_>,
    project: &Project,
...
pub(super) fn draw_preview_item_transitions(
    draw: &TimelineDraw<'_>,
    project: &Project,
    key: ItemKey,
    start: Time,
...
pub(super) fn draw_drag_indicator(
    draw: &TimelineDraw<'_>,
    project: &Project,
    virtual_tracks: &[(TrackKind, usize)],
...
pub(super) fn draw_virtual_track_ghosts(
    painter: &TimelinePainter,
    project: &Project,
    virtual_tracks: &[(TrackKind, usize)],
    timeline_x: f64,
...
pub(super) fn preview_row_for_track(
    project: &Project,
    virtual_tracks: &[(TrackKind, usize)],
    kind: TrackKind,
    track_index: usize,
...
pub(crate) fn active_virtual_tracks(
...
pub(super) fn visual_row_for_track(
    project: &Project,
    kind: TrackKind,
    track_index: usize,
    virtual_tracks: &[(TrackKind, usize)],
...
pub(super) fn draw_item_drag_outline(
    painter: &TimelinePainter,
    start: Time,
    end: Time,
    x: f64,
...
pub(super) fn draw_item_drag_status_outline(
    painter: &TimelinePainter,
    range: (Time, Time),
    x: f64,
    y: f64,

...
pub(crate) fn resize_drag_for_hit(
    project: &Project,
...
pub(crate) fn update_resize_drag(
    drag: &mut ResizeDrag,
    project: &Project,
...
pub(crate) fn apply_resize_drag(project: &mut Project, drag: ResizeDrag) -> Option<Vec<ItemKey>> {
...
pub(crate) fn resize_caption_items(
    project: &mut Project,
...
pub(crate) fn resize_video_items(
    project: &mut Project,
    placements: &[ItemPlacement],
    overwrite: bool,
    selection: &mut Vec<ItemKey>,
...
pub(crate) fn resize_audio_items(
    project: &mut Project,
    placements: &[ItemPlacement],
    overwrite: bool,
    selection: &mut Vec<ItemKey>,
...
pub(crate) fn cut_time_for_address(
    project: &Project,
    view: TimelineViewState,
...
pub(crate) fn split_item_address(
    project: &mut Project,
    address: &crate::project::ItemAddress,
    timeline_cut: Time,
...
pub(crate) fn item_times(project: &Project, key: ItemKey) -> Option<(Time, Time)> {
    match key.kind {
...
pub(crate) fn item_source_offset(project: &Project, key: ItemKey) -> Option<Time> {
    match key.kind {
...
pub(crate) fn resolve_resize_drag(project: &Project, drag: &mut ResizeDrag) {
...
pub(crate) fn resize_collides_with_project(
    project: &Project,
    drag: &ResizeDrag,
    placements: &[ItemPlacement],
) -> bool {
...
pub(crate) fn resize_placements(drag: &ResizeDrag) -> Option<Vec<ItemPlacement>> {
...
pub(crate) fn resize_collides_with_track(
    project: &Project,
    drag: &ResizeDrag,
...
pub(crate) fn resize_collides_with_items<T: Clone + TimeSlice>(
    items: &[T],
    drag: &ResizeDrag,
    placement: ItemPlacement,
) -> bool {
...
pub(crate) fn resize_collision_indicators(
    project: &Project,
    drag: &ResizeDrag,
    placements: &[ItemPlacement],
) -> Vec<DragIndicator> {
...
pub(crate) fn collect_resize_collision_indicators<T: TimeSlice>(
    items: &[T],
    drag: &ResizeDrag,
    placement: ItemPlacement,
